...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Examine the intent that was used to start this activity, in order figure out
        //if we are creating a new pet or editing an existing one.
    ...
    private void savePet() {
        ...
        Integer weight = 0;
        String weightStr = this.mWeightEditText.getText().toString();
        ...
        if (mPetUri == null) {
            mPetUri = getContentResolver().insert(PetContract.PetEntry.CONTENT_URI, values);
        } else {
